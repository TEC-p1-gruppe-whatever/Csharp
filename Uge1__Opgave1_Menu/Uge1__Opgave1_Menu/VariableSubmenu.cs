...
{
    class VariableSubmenu
    {
        public void VariableHovedmenuTekst()
        {// Tekst til brugeren om de forskellige opgaver
            Console.WriteLine("Velkommen til variable submenuen, her kan du se opgaver vedlagt i kategorien variabler."); 
        ...
        public (int, bool) SubmenuVariablerSelection()
        {
            ...
            do
            {
                ...
                {// Hvis brugerens indtastning er et tal, koere denne kode
                    ...
                    if(SubmenuSelected <=6 && SubmenuSelected >0) // Tjekker om brugerens indtastning, er indenfor de mulige valgmuligheder
        ...
        public void VariableHovedmenu()
        {
            bool MenuFaerdig = false; // variabel til at indikere om brugeren oensker at afslutte menuen
            do {
                
                VariableOpgaver Opgaver = new VariableOpgaver(); // opretter en genvej til menuens tilegnede opgaver
                Console.Clear();
                var(InputSelected, MenuFaerdigSub) = SubmenuVariablerSelection(); // Kalder metode, til at modtage brugerens indtastninger
