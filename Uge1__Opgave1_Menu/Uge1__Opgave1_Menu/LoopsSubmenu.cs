...
namespace Uge1__Opgave1_Menu
{
    class LoopsSubmenu
    {
        public void LoopHovedmenuTekst()
        {// Tekst til brugeren om de forskellige opgaver
            Console.WriteLine("Velkommen til Loops submenuen, her kan du se opgaver vedlagt i kategorien Loops.");
        ...
        public (int, bool) SubmenuLoopSelection()
        {
        ...
        public void LoopHovedmenu()
        {
            bool MenuFaerdig = false; // variabel til at indikere om brugeren oensker at afslutte menuen
            do
            {

                LoopOpgaver Opgaver = new LoopOpgaver(); // opretter en genvej til menuens tilegnede opgaver
                Console.Clear();
                var (InputSelected, MenuFaerdigSub) = SubmenuLoopSelection(); // Kalder metode, til at modtage brugerens indtastninger
